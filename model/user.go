...
type User struct {
	...
	AffiliateCommissionRate float64        `json:"affiliate_commission_rate" gorm:"type:decimal(10,4);not null;default:-1;column:affiliate_commission_rate"`
...
func (user *User) Insert(inviterId int, clientIP string) error {
	...
	if user.Setting == "" {
		defaultSetting := dto.UserSetting{
			RecordIpLog: common.GetPointer(true),
		}
...
func (user *User) Edit(updatePassword bool) error {
	...
	updates := map[string]interface{}{
		...
		"affiliate_commission_rate": newUser.AffiliateCommissionRate,
	}
	if updatePassword {
