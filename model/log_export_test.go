...
func TestGetAllLogsForExportSupportsCompactBillingRows(t *testing.T) {
	withLogStatTestDB(t, func() {
		...
		logs, total, truncated, err := GetAllLogsForExport(2, now-10, now+10, 43, "", "wqwe159", "", 0, "codex", "", "", "", "", 0, 0, false, true, LogExportFilters{})
...
func TestGetAllLogsForExportKeepsOrderAcrossBatches(t *testing.T) {
	withLogStatTestDB(t, func() {
		...
		logs, total, truncated, err := GetAllLogsForExport(2, now, now+10, 43, "", "wqwe159", "", 0, "codex", "", "", "", "", 0, 0, false, true, LogExportFilters{})
		require.NoError(t, err)
		require.False(t, truncated)
