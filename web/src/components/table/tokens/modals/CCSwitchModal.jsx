...
export default function CCSwitchModal({
  ...
  const effectiveAppConfigs = useMemo(() => {
    return {
      claude: {
        ...APP_CONFIGS.claude,
        defaultName:
          normalizedDefaults?.claude?.defaultName ||
          APP_CONFIGS.claude.defaultName,
      },
      codex: {
        ...APP_CONFIGS.codex,
        defaultName:
          normalizedDefaults?.codex?.defaultName ||
          APP_CONFIGS.codex.defaultName,
      },
    };
  }, [normalizedDefaults]);
  ...
  const currentDefaults =
    effectiveDefaultModels[app] || effectiveDefaultModels.claude;
  ...
  const mergedModelOptions = useMemo(() => {
    ...
    [
      ...
      ...Object.values(effectiveRecommendedModels).flatMap(
        (value) => value || [],
      ),
    ].forEach((model) => {
