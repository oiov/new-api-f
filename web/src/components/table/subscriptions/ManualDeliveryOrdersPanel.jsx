...
const ManualDeliveryOrdersPanel = ({ t }) => {
  ...
  return (
    <>
      ...
      <div className='rounded-[28px] border border-semi-color-border bg-semi-color-bg-0 p-3 shadow-sm md:p-5'>
        <div className='space-y-4'>
          <div className='flex flex-col gap-3 rounded-2xl border border-semi-color-border bg-gradient-to-r from-white to-semi-color-fill-0/60 p-4 shadow-[0_8px_24px_rgba(15,23,42,0.04)] md:flex-row md:items-start md:justify-between'>
            <div className='min-w-0'>
          ...
          <div className='rounded-2xl border border-semi-color-border bg-semi-color-fill-0/80 p-3 shadow-[0_8px_24px_rgba(15,23,42,0.04)]'>
          ...
          <div className='overflow-hidden rounded-2xl border border-semi-color-border bg-white p-2 shadow-[0_10px_30px_rgba(15,23,42,0.05)] dark:bg-semi-color-bg-0'>
            {isMobile ? (
              loading ? (
