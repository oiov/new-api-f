              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      setBoolOption("PasswordLoginEnabled", v)
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      setBoolOption("EmailVerificationEnabled", v)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-4 border-t pt-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      setBoolOption("GitHubOAuthEnabled", v)
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setOption("GitHubClientId", e.target.value)
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setOption("GitHubClientSecret", e.target.value)
                    }
                  />
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    setBoolOption("DisplayInCurrencyEnabled", v)
                  }
                />
              </div>
              <div className="flex items-center justify-between">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    setBoolOption("SubscriptionEnabled", v)
                  }
                />
              </div>
              <div className="space-y-2">
