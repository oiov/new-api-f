...
var defaultErrorSetting = ErrorSetting{
	...
	RestrictProxyDistributionAllowedHosts:   []string{"fishxcode.com", "*.fishxcode.com", "localhost", "127.0.0.1", "::1"},
	RestrictProxyDistributionAllowedSources: []string{"fishxcode.com", "*.fishxcode.com", "localhost", "127.0.0.1", "::1"},
	RestrictProxyDistributionBlockedMessage: "请勿使用反代等程序，请使用 https://fishxcode.com 中转站，如需外接请联系。",
}
